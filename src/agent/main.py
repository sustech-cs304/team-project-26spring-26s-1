...
import fastapi
from agent.db.database import Base, agent_database_path, create_session_factory, create_sqlite_engine
...
async def lifespan(app: fastapi.FastAPI):
	...
	log.info("ORM SQLite (single agent.db): %s", agent_database_path())
