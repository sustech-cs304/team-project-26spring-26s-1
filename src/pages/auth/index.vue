    ...
    <v-container class="fill-height d-flex align-center justify-center ">
        <v-row justify="center">
            <v-col cols="12" sm="10" md="8" lg="6" xl="4">
                ...
                <v-btn-toggle v-model="isSignIn" class="d-flex justify-center mb-6" color="cyan-darken-2" rounded="pill"
                    mandatory>
                    ...
                    <v-form v-if="isSignIn" ref="signInFormRef" @submit.prevent="onSignIn">
                        ...
                        <AuthTextField v-model="signInForm.password" label="Password" placeholder="Enter password"
                            ...
                            <template #label-append>
                                <v-btn variant="text" size="small" class="text-none" color="cyan-darken-2"
                        ...
                        <v-btn type="submit" block size="large" color="cyan-darken-2" class="text-none"
                            :loading="signInLoading" :disabled="signInLoading">
                            Sign In
                    ...
                    <v-form v-else ref="signUpFormRef" @submit.prevent="onSignUp">
                        <AuthTextField v-model="signUpForm.email" label="Email" placeholder="user@gmail.com"
                            ...
                            <template #append v-if="signUpForm.email.trim()">
                                <v-btn :disabled="countdown > 0" height="56" min-width="100" variant="tonal"
                                    color="cyan-darken-2" @click="sendCode">
                        ...
                        <AuthTextField v-model="signUpForm.confirmPassword" label="Confirm Password"
                            ...
                            :rules="confirmPasswordRules" class="mb-8" />
                ...
                <div class="d-flex align-center justify-center mt-6 text-grey">
                    ...
                    <span class="text-body-large">Credentials are stored locally and never sent to third-party
                        services</span>
                </div>
            </v-col>
        </v-row>
